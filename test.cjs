...
paper.project.importSVG(svg, { expandShapes: true, onLoad: function(item) {
    console.log('--- expandShapes: true ---');
    console.log(item.exportSVG({asString:true}));
    
    paper.project.clear();
    
    paper.project.importSVG(svg, { expandShapes: false, onLoad: function(item2) {
        console.log('\n--- expandShapes: false ---');
        console.log(item2.exportSVG({asString:true}));
    }});
}});
